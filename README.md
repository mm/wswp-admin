...
* `REACT_APP_API_URL`: The base URL for making all API requests. If you're running the backend locally, this might be something like `http://localhost:8000/v1`
